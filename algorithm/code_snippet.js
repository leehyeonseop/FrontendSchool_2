...
// 문제 : head -> [90, next] -> [2, next] -> [77, next] -> [35, next] -> [21, next] -> null
// 35를 출력해주세요!
const list2 = {
    head : {
        value : 90,
...
list2.head.next.next.next.value
...
// 3.3 병합정렬(Worst와 Best 모두 O(nlogn), 어떤 정렬보다 빠름, 동일 할 수 없음)
